<main class="my-8">
  <div class="container mx-auto px-6">
    <h3 class="text-gray-700 text-2xl font-medium">Berlin</h3>
    <span class="mt-3 text-sm text-gray-500">20+ Products</span>
    <div
    ...
    <h3 class="text-gray-700 text-2xl font-medium">Other Cities</h3>
